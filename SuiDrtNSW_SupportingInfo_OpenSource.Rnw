% NOTES:  THIS IS THE bits from the  UNABRIDGED VERSION only
...
%%++++++++ Title page begins ++++++++%%
\title{Open Source Supporting Information for the article:\\ ``Suicide and Drought in NSW, Australia, 1970-2007''.}
...
%%\section{Introduction}
        This document accompanies the R code at this website \url{https://github.com/ivanhanigan/SuicideAndDroughtInNSW} to  reproduce the work published
 for the paper `Suicide and Drought in New South Wales (NSW), Australia, 1970-2007' (doi:10.1073/pnas.1112965109).
 These results were not included in that paper or the supporting information published with PNAS, so are published here as open source additional material.

        %% calculate the Hutchinson Drought Index and fit the regression models for the paper `Suicide and Drought in New South Wales (NSW), Australia, 1970-2007'.  The calculation of the Drought Index is demonstrated using free data from the Australian Bureau of Meteorology. The suicide mortality data are not publicly available due to confidentiality restrictions. The R code we ran the regressions with is included but the original data are only available for authorised users approved by the Australian Bureau of Statistics and the NSW Registrar of Births Deaths and Marriages.
...
\caption{Drought in Seymour Victoria 1994-99 using the enhanced Hutchinson index}
...
% \subsection{core model}
 ...
 %% unabridged
        ...
        \caption{Core model diagnostic plots}
...
\subsection{Check Climate}
 ...
 %% unabridged
        ...
        \caption{Drought and maximum temperature anomalies GAM results}
...
\subsection{Enhanced Drought Index}
 ...
 %%\subsection{Enhanced Drought Index}
        ...
        \caption{Interaction between drought and age, sex and rural using the enhanced Hutchinson index}
...
\subsection{Self-harm Coded as Undetermined}
 ...
 %%\subsection{Self-harm Coded as `Undetermined if Intentional'}
        ...
        \caption{Interaction of drought, age, sex and rural for all suicides along with deaths with undetermined intent}
...
\subsection{Plot Check}
        ...
        \caption{Interaction of drought, age, sex and rural: checks for high leverage}
...
\subsection{Plot Do}
 ...
 \begin{figure}[!h]
        ...
        \caption{Interaction of drought, age, sex and rural: no leverage points}
